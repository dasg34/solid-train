...
or a file, persists it to a local file, and sends a Tizen App Control launch
request to `com.example_tv_genui`.
...
- the launcher sends the payload file path using App Control extra data key
  `file`
