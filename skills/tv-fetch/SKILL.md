---
name: tv-fetch
description: "TV 도메인 데이터를 가져올 때 사용하는 tv_fetch CLI 가이드. 날씨, 뉴스, 금융, 출퇴근, 스포츠 등 TV 시나리오 데이터가 필요하거나, tv_fetch 실행·확장할 때 이 스킬을 사용한다. '데이터 가져와', 'mock 데이터', 'fetch' 같은 요청에도 트리거한다."
---
