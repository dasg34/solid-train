...
bool JsonValue::IsString() const noexcept {
  return object_ != nullptr && json_object_is_type(object_, json_type_string);
}

bool JsonValue::IsBoolean() const noexcept {
  return object_ != nullptr && json_object_is_type(object_, json_type_boolean);
}

bool JsonValue::IsNumber() const noexcept {
  return object_ != nullptr &&
         (json_object_is_type(object_, json_type_int) ||
          json_object_is_type(object_, json_type_double));
}
